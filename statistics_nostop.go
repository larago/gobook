...
func homePage(writer http.RequestWriter, request *http.Request) {
    defer func() {
        if x := recover(); x != nil {
...
func processRequest(request *http.Request) ([]float64, string, bool) {
    for _, found := request.Form["panic"]; found {
...
func getStats(numbers []float64) (stats statistics) {
    ...
    stats.mena = sum(numbers) / float64(len(numbers))
